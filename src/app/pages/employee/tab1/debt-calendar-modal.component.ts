...
@Component({
  selector: 'app-debt-calendar-modal',
  templateUrl: './debt-calendar-modal.component.html',
  styleUrls: ['./debt-calendar-modal.component.scss'],
  standalone: false  // Remove the imports array completely
})
export class DebtCalendarModalComponent implements OnInit {
